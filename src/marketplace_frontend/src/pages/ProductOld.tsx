...
const ProductOld = () => {
  ...
  useEffect(() => {
    if (id && products) {
      const product = products.find((product: ProductOld) => product.id === id);
      ...
      if (product) {
        ...
        console.log("ProductOld with ID not found");
        setLoading(false);
      }
    }
  }, [id, products]);
  ...
  return (
    <div className="px-7 lg:px-28 pt-8 pb-10">
        ...
        <div className="grid grid-rows-1 md:flex flex-row mb-12">
          ...
          <div className="flex flex-col py-2 md:w-5/12">
            ...
            <div className="flex flex-row mt-12">
              ...
              <h3 className="text-gray-600 text-lg">1 customer review</h3>
            </div>
            <div>
            ...
            <div className="flex flex-row items-center mt-6">
              ...
              <p className="font-semibold text-lg mx-4">Kgs</p>
              <div className="w-48">
                <Button
                  text="Place Order"
                  width="full"
            ...
            <div className="flex flex-row mt-10">
              <div className="flex border-r-2 border-gray-200 pr-6">
                <button className="group">
                  <svg
                    className="fill-primary h-4 w-5"
                    viewBox="0 0 20 18"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="flex ml-2">
                <img className="h-4 w-5 ml-2" src={Mail} alt="Mail" />
                <img className="h-4 w-5 ml-2" src={Facebook} alt="Facebook" />
                <img className="h-4 w-5 ml-2" src={Instagram} alt="Instagram" />
              </div>
            </div>
            <div className="flex flex-row mt-4">
      ...
      <div className="flex flex-row md:ml-24">
        {infoItems.map((item, index) => (
          <button
            ...
            key={index}
            className={`mr-8 border-b-2 pb-6 ${
      ...
      <div className="ml-24">
        <h1 className="font-bold mt-10 text-3xl text-primary">
          Related Products
        </h1>
      </div>
