...
export default function KYC() {
  ...
  const schema = z.object({
    username: z.string().min(3, { message: "Username must be 3 or more characters long" }).max(40, { message: "Username must be less than 40 characters long" }),
    ...
    about: z.string().min(20, { message: "About section must be at least 20 characters long" }).max(500, { message: "About section must be less than 500 characters long" }),
    organization: z.string().min(3, { message: "Organization name must be at least 3 characters long" }).max(50, { message: "Organization name must be less than 50 characters long" }),
    email: z.string().email({ message: "Please provide a valid email address" }),
    country: z.string().min(3, { message: "Country name must be at least 3 characters long" }).max(40, { message: "Country name must be less than 40 characters long" }),
    province: z.string().min(3, { message: "Province name must be at least 3 characters long" }).max(40, { message: "Province name must be less than 40 characters long" }),
    streetAddress: z.string().min(5, { message: "Street address must be at least 5 characters long" }).max(100, { message: "Street address must be less than 100 characters long" }),
    city: z.string().min(3, { message: "City name must be at least 3 characters long" }).max(40, { message: "City name must be less than 40 characters long" }),
    zipCode: z.number(),
    profilePhoto: z
      .any()
          ...
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2">
                    <textarea
                      ...
                      {...register("about")}
                      rows={3}
                      className="block w-full bg-transparent rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
                    />
                  </div>
                  {errors.about && <span className="text-red-600">{errors.about.message}</span>}
                ...
                <div className="col-span-full">
                  ...
                  {errors.profilePhoto && (
                    <span className="text-red-600">{errors.profilePhoto.message}</span>
                  )}
                  <br/>
                  {profilePhoto && (
                    <>
            ...
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      {...register("firstName")}
                      id="first-name"
                      className="block w-full bg-transparent rounded-md border-0 px-2.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
                    />
                  </div>
                ...
                <div className="sm:col-span-4">
                  ...
                  {errors.organization && (
                    <span className="text-red-600">{errors.organization.message}</span>
                  )}
                </div>
                ...
                <div className="col-span-full">
                  ...
                  {errors.streetAddress && (
                    <span className="text-red-600">{errors.streetAddress.message}</span>
                  )}
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  {errors.province && <span className="text-red-600">{errors.province.message}</span>}
                </div>
            ...
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="col-span-full pb-6 pt-6">
                ...
                {errors.kycID && <span className="text-red-600">{errors.kycID.message}</span>}
                <br/>
              ...
              <div className="col-span-full">
                ...
                {errors.proofOfAddress && (
                  <span className="text-red-600">{errors.proofOfAddress.message}</span>
                )}
                <br/>
                {proofOfAddress && (
                  <>
