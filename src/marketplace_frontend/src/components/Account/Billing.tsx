...
const plans = [
    { name: 'Startup', priceMonthly: 29, priceYearly: 290, limit: 'Up to 5 active orders postings' },
    { name: 'Business', priceMonthly: 99, priceYearly: 990, limit: 'Up to 25 active orders postings' },
    { name: 'Enterprise', priceMonthly: 249, priceYearly: 2490, limit: 'Unlimited active orders postings' },
]
                    ...
                    <div className="shadow sm:overflow-hidden sm:rounded-md">
                        ...
                        <div className="mt-6 grid grid-cols-4 gap-6">
                            ...
                            <input
                                ...
                                className="mt-1 block w-full rounded-md border bg-white border-gray-300 py-2 px-3 shadow-sm focus:border-primary focus:outline-none focus:ring-gray-900 sm:text-sm"
                            />
                            </div>
                            ...
                            <select
                                ...
                                className="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-primary focus:outline-none focus:ring-gray-900 sm:text-sm"
                            >
                        ...
                        <RadioGroup value={selectedPlan} onChange={setSelectedPlan}>
                            ...
                            {plans.map((plan, planIdx) => (
                                ...
                                className={({ checked }) =>
                                    ...
                                    checked ? 'bg-green-200 border-orange-200 z-10' : 'border-gray-200',
                                ...
                                {({ active, checked }) => (
                                    ...
                                    >
                                        ...
                                        <span className={checked ? 'text-primary' : 'text-gray-500'}>
                                        (${plan.priceYearly} / yr)
                                        </span>
                                    </RadioGroup.Description>
                                    <RadioGroup.Description
