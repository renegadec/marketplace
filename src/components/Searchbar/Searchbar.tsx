const Searchbar = () => {
    return (
        <div className="flex h-[60px] w-full xl:w-3/5 bg-gray-200 border-primary p-1 border-[1px] rounded-[40px]">
            <input 
                type="text" 
                placeholder="Search for product..."
                className="text-gray-800 placeholder-gray-800 bg-transparent ml-[5%] w-[75%] focus:outline-none" />
            <button className="flex justify-center place-items-center p-2 bg-primary hover:bg-indigo-700 text-white h-full w-[25%] rounded-[40px]">
