                ...
                <form action="#">
                    <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        <div className="relative w-full">
                            ...
                            <input className="block p-3 pl-10 w-full text-sm text-gray-900 bg-white rounded-lg border border-primary sm:rounded-none sm:rounded-l-lg focus:ring-primary focus:border-primary dark:bg-white dark:border-primary dark:placeholder-gray-500 dark:text-black dark:focus:ring-primary dark:focus:border-primary" placeholder="Enter your email" type="email" id="email" required />
                        </div>
                        <div>
