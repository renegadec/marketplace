                ...
                <form action="#">
                    <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        <div className="relative w-full">
                            ...
                            <input className="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary focus:border-primary-500 dark:bg-gray-700 dark:border-primary dark:placeholder-gray-500 dark:text-black dark:focus:ring-primary dark:focus:border-primary" placeholder="Enter your email" type="email" id="email" required />
                        </div>
                        <div>
                    ...
                    <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-600 newsletter-form-footer dark:text-gray-700">We care about the protection of your data. <a href="#" className="font-medium text-primary dark:text-primary hover:underline">Read our Privacy Policy</a>.</div>
                </form>
            </div>
        </div>
    </section>
