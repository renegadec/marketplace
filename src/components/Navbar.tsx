...
const Navbar = () => {
    ...
    useEffect(() => {
        async function checkAuth() {  
            ...
            // setIsLoggedIn(userSession.data.session.user ? true : false)    
        }
        checkAuth().then(() => {
            setIsMounted(true)
        })
                ...
                <div className=" border-gray-200 px-4 lg:px-6 py-2.5 ">
                    <div className="flex flex-wrap justify-between items-center">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            {/* -- Dropdown menu -- */}
                            {isNotificationsOpen && 
                            <div className={`${isNotificationsOpen ? "" : "hidden"} fixed top-20 md:top-12 right-3  overflow-hidden z-50 my-4 max-w-sm text-base    list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700`} id="notification-dropdown">
                                ...
                                <div>
                                    {notifications.map((item) => (
                                        <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                                            ...
                                            <img className="w-11 h-11 rounded-full" src={item.image} alt="Bonnie Green avatar" />
                                            ...
                                            <div className="pl-3 w-full">
                                                <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">New message from <span className="font-semibold text-gray-900 dark:text-white">{item.username}</span>: {item.message}</div>
                                                <div className="text-xs font-medium text-primary-700 dark:text-primary-400">{item.time}</div>
                                            </div>
                                        </a>
                                    ))}
                                </div>
                            ...
                            <div className={`${isAppsOpen ? "" : "hidden"} fixed top-12 right-3 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600`} id="apps-dropdown">
                                <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    Apps
                                </div>
                            ...
                            {/* -- Dropdown menu  */}
                            {isProfileOpen && <div className={`${isProfileOpen ? "" : "hidden"} fixed top-12 right-2 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600`} id="dropdown">
                                <div className="py-3 px-4">
                                    <span className="block text-sm font-semibold text-gray-900 dark:text-white">James Bond</span>
                                    <span className="block text-sm font-light text-gray-500 truncate dark:text-gray-400">james@purchasing.com</span>
                                </div>
                                <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                    <li>
                                        <a href="#" className="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Dashboard</a>
                                    </li>
                                    <li>
                                ...
                                <ul className="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                    <li>
                                        ...
                                        <a onClick={() => logout()} href="/" className="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sign out</a>
                                    </li>
                                </ul>
                            </div>}
                        </div>
