            ...
            <main>
                <div className="relative px-6 lg:px-8">
                    <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
                            ...
                            <div>
                                <h1 className="text-3xl font-semibold md:text-5xl md:font-bold text-primary tracking-tight text-center">
                                    Empowering farmers to achieve sustainable growth
                                </h1>
                                <p className={`${styles.paragraph} mt-6 text-gray-600 text-center`}>
